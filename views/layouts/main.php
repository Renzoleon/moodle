    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Tablas','items'=>[
                    ...
                    ['label'=>'Area Formativa','url'=>'/area-formativa/index'],
                    ['label'=>'Horas Dictado','url'=>'/curso-horasdictado/index'],
                    ['label'=>'Tipo de Curso','url'=>'/curso-tipocurso/index'],
                    ['label'=>'Tipo de Dictado','url'=>'/curso-tipodictado/index'],
            ]],
            ['label' => 'Gii', 'url' => ['/gii']],
